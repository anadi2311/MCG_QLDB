            ...
            #check if container_exist
                ...
                if import_custom_approved:
                    ...
                    if isContainerSafe(transaction_executor,container_id):
                        ...
                        logger.info("Contianer not safe.")  
                else:
...
if __name__ == '__main__': 
    try:
        with create_qldb_driver() as driver:
            ...
            pickuprequestid = "6GZuasxqwRSEASZlnZRzR6" #96EioNwSjcq8HKLBRjcvPp
            pickuppersonid = "42BH1juMINuLDCY0MJY3bJ"
            driver.execute_lambda(lambda executor: deliver_product_to_distributor(executor, pickuprequestid, pickuppersonid))
    except Exception:
