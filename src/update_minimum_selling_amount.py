...
if __name__ == '__main__': 
    try:
        with create_qldb_driver() as driver:
            ...
            productid = "BFJKrHD4JBH0VPR609Yvds" 
            minimumsellingamount = 2       # in number of containers
            newproductprice = 21 # price per container
            distributorpersonid = "7rq5FLKmPdVJi7fpGk5BEp"
