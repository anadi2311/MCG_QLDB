...
def insert_caseIds (transaction_executor,batch_table_name,batch_id,case_id_values):
    ...
    try:
        ...
        raise Exception("Problem inserting case Ids")
                    ...
                    if shipment_already_started(transaction_executor,purchase_order_id):                    
                        ...
                        if batch_table_id:
                            ...
                            if product_units_ordered:
                                ...
                                raise Exception(" First produce and register the vaccines into the sytem before shipping them")
                        else: 
                            raise Exception('Register the Batch table first by inputting inventory!')
                else:
