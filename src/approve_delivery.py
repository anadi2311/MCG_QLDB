...
def insert_value_in_inventory_table(transaction_executor,inventory_table,field,inventory_id,value):
    ...
    try:
        ...
        raise Exception("Problem inserting value in inventory table")
                ...
                if isContainerSafe:
                    ...
                    if is_container_delivered == [0]:
                        ...
                        if import_custom_approved:
                            ...
                            raise Exception("Container Not Approved by Import Customs")
                    else:
                        raise Exception("Container Already Delivered")
                else:
                    raise Exception("A L A R M================C O N T A I N E R=======N O T=======S A F E ==========")
